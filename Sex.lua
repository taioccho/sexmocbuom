...
-- ============================================================
-- TOGGLE UI | Left Control | Flip Animation | RbxAssetId
-- ============================================================
local Players = game:GetService("Players")
...
-- Container giữ nút (để làm flip 3D)
local ButtonFrame = Instance.new("Frame")
ButtonFrame.Name = "ButtonFrame"
ButtonFrame.Size = UDim2.new(0, 80, 0, 80)
ButtonFrame.Position = UDim2.new(0, 20, 0.5, -40)
ButtonFrame.BackgroundTransparency = 1
ButtonFrame.AnchorPoint = Vector2.new(0, 0)
ButtonFrame.Parent = ScreenGui

-- Mặt trước (ON face)
local FrontFace = Instance.new("ImageLabel")
FrontFace.Name = "FrontFace"
FrontFace.Size = UDim2.new(1, 0, 1, 0)
FrontFace.Position = UDim2.new(0, 0, 0, 0)
FrontFace.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
FrontFace.BorderSizePixel = 0
FrontFace.Image = "rbxassetid://5009915795" -- Ảnh mặt trước (thay bằng asset id của bạn)
FrontFace.ImageColor3 = Color3.fromRGB(255, 255, 255)
FrontFace.ScaleType = Enum.ScaleType.Fit
FrontFace.Parent = ButtonFrame

local FrontCorner = Instance.new("UICorner")
FrontCorner.CornerRadius = UDim.new(1, 0)
FrontCorner.Parent = FrontFace

local FrontStroke = Instance.new("UIStroke")
FrontStroke.Color = Color3.fromRGB(0, 200, 100)
FrontStroke.Thickness = 2.5
FrontStroke.Parent = FrontFace

-- Mặt sau (OFF face)
local BackFace = Instance.new("ImageLabel")
BackFace.Name = "BackFace"
BackFace.Size = UDim2.new(1, 0, 1, 0)
BackFace.Position = UDim2.new(0, 0, 0, 0)
BackFace.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
BackFace.BorderSizePixel = 0
BackFace.Image = "rbxassetid://7072706620" -- Ảnh mặt sau (thay bằng asset id của bạn)
BackFace.ImageColor3 = Color3.fromRGB(180, 180, 180)
BackFace.ScaleType = Enum.ScaleType.Fit
BackFace.ImageTransparency = 0
BackFace.Visible = false
BackFace.Parent = ButtonFrame

local BackCorner = Instance.new("UICorner")
BackCorner.CornerRadius = UDim.new(1, 0)
BackCorner.Parent = BackFace

local BackStroke = Instance.new("UIStroke")
BackStroke.Color = Color3.fromRGB(180, 50, 50)
BackStroke.Thickness = 2.5
BackStroke.Parent = BackFace
...
KeyLabel.Position = UDim2.new(0, 0, 1, 26)
KeyLabel.BackgroundTransparency = 1
KeyLabel.Text = "[L-CTRL]"
...
local function flipToggle()
    ...
    -- Phase 1: thu lại (scale X về 0) - nửa đầu lật
    local shrinkTween = TweenService:Create(ButtonFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
        Size = UDim2.new(0, 0, 0, 80)
    })
    shrinkTween:Play()
    shrinkTween.Completed:Wait()

    -- Đổi mặt giữa lúc thu
    ...
    if isVisible then
        ...
        BackStroke.Color = Color3.fromRGB(200, 50, 50)
    end

    -- Phase 2: mở rộng lại (scale X về 80) - nửa sau lật
    local expandTween = TweenService:Create(ButtonFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    ...
    -- Hiệu ứng bounce nhẹ
    local bounceTween = TweenService:Create(ButtonFrame, TweenInfo.new(0.1, Enum.EasingStyle.Bounce, Enum.EasingDirection.Out), {
        Size = UDim2.new(0, 86, 0, 86)
    })
    bounceTween:Play()
    bounceTween.Completed:Wait()

    local restoreTween = TweenService:Create(ButtonFrame, TweenInfo.new(0.08, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
        Size = UDim2.new(0, 80, 0, 80)
    })
    restoreTween:Play()
...
RunService.Heartbeat:Connect(function()
    if isVisible and not isAnimating then
        local t = tick()
        local alpha = (math.sin(t * 3) + 1) / 2
        FrontStroke.Thickness = 2 + alpha * 1.5
    end
end)
-- ============================================================
