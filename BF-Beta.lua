...
elseif _PlaceId == 7449423635 or _PlaceId == 100117331123089 then
    World3 = true
elseif _PlaceId == 73902483975735 then
    Dungeon = true
else
...
ScreenGui.Name = "Fluent_HideUI_Toggle"
...
HideButton.Size = UDim2.fromOffset(48, 48)
HideButton.Position = UDim2.new(0, 20, 0, 40)
HideButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
HideButton.Image = "rbxassetid://5009915795"
HideButton.ZIndex = 999999
...
local dragStart, startPos, currentTrackInput
local dragConnection

local function updateLoop()
    if dragging and currentTrackInput then
        local delta = currentTrackInput.Position - dragStart
        
        -- Nếu di chuyển hơn 5 pixel mới tính là kéo thả
...
HideButton.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        currentTrackInput = input
        
        -- Kích hoạt vòng lặp RenderStepped để di chuyển mượt mà bám sát ngón tay
        dragConnection = RunService.RenderStepped:Connect(updateLoop)
        
        input.Changed:Connect(function()
            if input.UserInputState == Enum.UserInputState.End then
                dragging = false
                currentTrackInput = nil
                if dragConnection then
                    dragConnection:Disconnect()
                end
                
                -- Nếu chỉ chạm nhẹ và nhấc ra (không kéo quá 5px) thì thực hiện nhấn nút
...
-- Cập nhật tọa độ input liên tục khi ngón tay/chuột di chuyển
