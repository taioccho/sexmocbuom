        ...
        function sectionFunction:AddButton(Setting, Callback)
            ...
            TextColor_1.Parent = RowBG_1
             ...
             UIGradient_1.Color = ColorSequence.new{
                 ...
                 ColorSequenceKeypoint.new(0.6, Color3.fromRGB(255, 206, 27)),
                 ColorSequenceKeypoint.new(1, Color3.fromRGB(240, 190, 20))
             }
             ...
             Button_1.Text = "Click"
             Button_1.TextColor3 = Color3.fromRGB(18, 18, 22)
			...
			function sectionFunction:AddDropdown(idk, Setting)
				...
				-- Nếu Search=true: thêm TextLabel hiển thị title/selected, ẩn khi gõ
				local SearchTitleLabel
				if Search then
					SearchTitleLabel = Instance.new("TextLabel")
					SearchTitleLabel.Name = "SearchTitleLabel"
					SearchTitleLabel.Parent = Topdrop
					SearchTitleLabel.BackgroundTransparency = 1
					SearchTitleLabel.Position = UDim2.new(0, 10, 0, 0)
					SearchTitleLabel.Size = UDim2.new(1, -40, 1, 0)
					SearchTitleLabel.Font = Enum.Font.GothamBlack
					SearchTitleLabel.TextSize = 14
					SearchTitleLabel.TextXAlignment = Enum.TextXAlignment.Left
					SearchTitleLabel.TextColor3 = getgenv().UIColor["Text Color"]
					SearchTitleLabel.Text = Title .. ': ' .. tostring(Default or "")
					SearchTitleLabel.ZIndex = 2
					-- TextBox nằm dưới, ẩn placeholder bằng cách đặt lại
					Dropdowntitle.PlaceholderText = "Tìm kiếm..."
					Dropdowntitle.ZIndex = 3
					Dropdowntitle.Text = ""
					-- Khi focus vào textbox → ẩn label
					Dropdowntitle.Focused:Connect(function()
						SearchTitleLabel.Visible = false
					end)
					-- Khi mất focus → nếu text rỗng thì hiện lại label
							...
							if typeof(v) == "string" then
								...
								SampleItemButton.MouseButton1Click:Connect(function()
									if Search then
										...
										Sel.Value = v
										-- Cập nhật title label khi chọn xong
										if SearchTitleLabel then
											SearchTitleLabel.Text = Title .. ': ' .. v
											SearchTitleLabel.Visible = true
										end
									else
				...
				DropdownButton.MouseButton1Click:Connect(function()
					-- Nếu Search=true: clear text và hiện lại title khi toggle
					if Search and Dropdowntitle then
						Dropdowntitle.Text = ""
						if SearchTitleLabel then
							SearchTitleLabel.Visible = true
						end
