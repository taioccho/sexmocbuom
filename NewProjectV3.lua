...
local function toggleUI()
    _uiOpen = not _uiOpen
    Window:SetMinimized(not _uiOpen)
end

-- Bấm button
Button.MouseButton1Click:Connect(function()
    TweenService:Create(Image, TweenInfoClick, { Size = UDim2.new(0, 35, 0, 35) }):Play()
    task.wait(0.08)
    TweenService:Create(Image, TweenInfoClick, { Size = UDim2.new(0, 40, 0, 40) }):Play()
    toggleUI()
end)
