...
Tabs.Stack:AddToggle('Toggle', {
    ...
    getgenv().PirateRaid = p562
local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local RunService = game:GetService("RunService")
local player = Players.LocalPlayer
    StopTween(getgenv().PirateRaid)
end)
...
local isTweeningPirate = false
                                AutoHaki()
                                EquipWeapon(getgenv().SelectWeapon)
-- Vòng lặp khóa ghim nhân vật tránh rơi rớt khi Tween quái
...
-- Tính năng gom quái Raid lại một chỗ (Bring Mobs)
task.spawn(function()
...
-- Vòng lặp quét tìm quái Raid và Tự động di chuyển (Tween) tới xử lý
...
local minimizeButton = Window.MinimizeButton

if minimizeButton then
    -- Đặt nền màu TRẮNG tinh cho nút thu nhỏ
    minimizeButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    minimizeButton.BackgroundTransparency = 0
    
    -- Biến nút thành hình tròn hoàn hảo
    local uiCorner = minimizeButton:FindFirstChildOfClass("UICorner") or Instance.new("UICorner", minimizeButton)
    uiCorner.CornerRadius = UDim.new(1, 0)
    
    -- Khóa kích thước vuông (ví dụ: 45x45) để nút tròn không bị méo
    minimizeButton.Size = UDim2.fromOffset(45, 45)
    
    -- Xóa các icon mặc định bên trong nút thu nhỏ cũ
    ...
    -- Tạo ImageLabel mới để chèn Logo của bạn lên trên nền trắng
    local logoLabel = Instance.new("ImageLabel")
    logoLabel.Name = "ToggleLogo"
    logoLabel.Size = UDim2.fromScale(0.65, 0.65) -- Logo chiếm 65% diện tích nút tròn
    logoLabel.Position = UDim2.fromScale(0.5, 0.5)
    logoLabel.AnchorPoint = Vector2.new(0.5, 0.5)
    logoLabel.BackgroundTransparency = 1
    
    -- THAY ASSET ID LOGO CỦA BẠN TẠI ĐÂY
    logoLabel.Image = "rbxassetid://YOUR_LOGO_ID" 
    
    -- Nếu logo của bạn màu trắng, hãy bỏ dấu gạch chéo dòng dưới để nhuộm đen nó (giúp nổi trên nền trắng)
    -- logoLabel.ImageColor3 = Color3.fromRGB(0, 0, 0)
    
    logoLabel.Parent = minimizeButton
end